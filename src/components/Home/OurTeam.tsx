...
export default function OurTeam() {
  ...
  return (
    <div className="text-center px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
      {/* Section title and description from en.json */}
      <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4 text-[#7B4B2B]">{en.team.sectionTitle}</h2>
